...
QColor Util::toColor (const QString& colorString)
{
    ...
    {
        alpha = colorString.mid(2, 2).toInt(Q_NULLPTR, 16);
        red = colorString.mid(4, 2).toInt(Q_NULLPTR, 16);
        green = colorString.mid(6, 2).toInt(Q_NULLPTR, 16);
        blue = colorString.mid(8, 2).toInt(Q_NULLPTR, 16);
